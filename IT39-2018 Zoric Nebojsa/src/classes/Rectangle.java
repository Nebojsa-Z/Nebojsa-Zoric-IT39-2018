...
public class Rectangle extends SurfaceShape {
	...
	public String toStringStack() {
		...
		return "Rectangle " + (Stack.getDlmStack().getSize()+ 1) + "Upper left point coordinates:(" 
		       + String.valueOf(getX()) + "," + String.valueOf(getY()) + "),Width:"
	...
	public String toStringSort() {
		...
		return "Upper left point coordinates:(" + String.valueOf(getX()) + ","
				+ String.valueOf(getY()) + "),Width:" + String.valueOf(getWidth()) + ",Height:" 
				+ String.valueOf(getHeight()) + ",Area:" + getArea();
	}
